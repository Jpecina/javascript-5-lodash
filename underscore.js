...
const listOfSharedEmails = _.intersection(breeFriendsEmails,bobFriendsEmails); // Use underscore to create the list that are in both lists
...
// Bonus Points
const totalByMonth = _.groupBy(); // Use the groupded purchasesByMonth and reduce to create a totalByMonth object.
